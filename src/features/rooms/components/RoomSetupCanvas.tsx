    ...
    <View style={styles.page}>
      <View style={styles.appBarShadow}>
        <View style={[styles.appBar, { paddingTop: Math.max(insets.top, 8) }]}>
          ...
          <AppText style={[styles.brand, { fontFamily: heavyFont }]}>Color Log</AppText>
  ...
  return (
    <View style={styles.buttonShadow}>
      <Pressable
        ...
        {tone === 'dark' ? <LoginIcon color={colors.surface} /> : <ArrowIcon />}
      </Pressable>
    </View>
  );
}
  ...
  return (
    <>
      <View style={styles.boardSection}>
        {isLoading ? <View accessibilityLiveRegion="polite" style={styles.boardState}><ActivityIndicator color={colors.ink} /><AppText style={styles.boardStateText}>오늘의 캔버스를 준비하고 있어요.</AppText></View> : null}
...
function PencilIcon() {
  const { colors } = useAppTheme();
  return <Svg height={22} viewBox="0 0 24 24" width={22}><Path d="m5 19 3.3-.7L19 7.6 16.4 5 5.7 15.7 5 19Z" fill="none" stroke={colors.ink} strokeLinejoin="round" strokeWidth={1.8} /><Path d="m15.7 5.7 2.6 2.6" fill="none" stroke={colors.ink} strokeLinecap="round" strokeWidth={1.8} /></Svg>;
}

function GearIcon() {
  const { colors } = useAppTheme();
  return <Svg height={21} viewBox="0 0 24 24" width={21}><Circle cx={12} cy={12} fill="none" r={3} stroke={colors.ink} strokeWidth={1.7} /><Path d="M12 3.5v2M12 18.5v2M20.5 12h-2M5.5 12h-2m14.5-6.5-1.4 1.4M7 17l-1.4 1.4m0-12.8L7 7m9.6 9.6 1.4 1.4" fill="none" stroke={colors.ink} strokeLinecap="round" strokeWidth={1.7} /></Svg>;
}

function KeyIcon() {
  const { colors } = useAppTheme();
  return <Svg height={48} viewBox="0 0 48 48" width={48}><Circle cx={17} cy={19} fill="none" r={8} stroke={colors.ink} strokeWidth={2} /><Path d="m23 25 14 14m-5-5 3-3m-7-2 3-3" fill="none" stroke={colors.ink} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /></Svg>;
}

function DoorIcon() {
  const { colors } = useAppTheme();
  return <Svg height={48} viewBox="0 0 48 48" width={48}><Path d="M12 39V10l21-3v32M12 39h24M17 14v25m0-20 11-1v21" fill="none" stroke={colors.ink} strokeLinejoin="round" strokeWidth={2} /><Circle cx={25.5} cy={28} fill={colors.ink} r={1.5} /></Svg>;
}

function SparkleIcon() {
  const { colors } = useAppTheme();
  return <Svg height={42} viewBox="0 0 48 48" width={42}><Path d="M24 4c1.7 11 8.6 17.8 20 20-11.4 2.1-18.3 9-20 20-2-11-8.7-17.9-20-20C15.3 21.8 22 15 24 4Z" fill="none" stroke={colors.ink} strokeLinejoin="round" strokeWidth={2.2} /></Svg>;
}

function ArrowIcon() {
  const { colors } = useAppTheme();
  return <Svg height={22} viewBox="0 0 24 24" width={22}><Path d="M4 12h15m-6-6 6 6-6 6" fill="none" stroke={colors.ink} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} /></Svg>;
}
...
function HistoryIcon() {
  const { colors } = useAppTheme();
  return <Svg height={18} viewBox="0 0 24 24" width={18}><Path d="M4.8 7.5V4.8m0 2.7h2.7m-2.7 0a8 8 0 1 1-1 7.6M12 8v4.2l2.9 1.8" fill="none" stroke={colors.ink} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} /></Svg>;
}

function PaletteIcon() {
  const { colors } = useAppTheme();
  return <Svg height={23} viewBox="0 0 24 24" width={23}><Path d="M12 3.8a8.6 8.6 0 0 0 0 17.2h1.7a1.7 1.7 0 0 0 0-3.4h-.3a1.2 1.2 0 0 1 0-2.4h1.1A5.7 5.7 0 0 0 12 3.8Z" fill="none" stroke={colors.ink} strokeLinejoin="round" strokeWidth={1.5} /><Circle cx={8.2} cy={10.2} fill={colors.ink} r={1} /><Circle cx={12} cy={7.6} fill={colors.ink} r={1} /><Circle cx={15.7} cy={10.2} fill={colors.ink} r={1} /></Svg>;
}

function PersonAddIcon() {
  const { colors } = useAppTheme();
  return <Svg height={16} viewBox="0 0 24 24" width={16}><Circle cx={9} cy={8} fill="none" r={3} stroke={colors.ink} strokeWidth={1.7} /><Path d="M3.8 19c.4-3 2.1-4.7 5.2-4.7s4.8 1.7 5.2 4.7m1.5-10.5h5m-2.5-2.5v5" fill="none" stroke={colors.ink} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.7} /></Svg>;
}

function TuneIcon() {
  const { colors } = useAppTheme();
  return <Svg height={16} viewBox="0 0 24 24" width={16}><Path d="M4 7h16M4 12h16M4 17h16" fill="none" stroke={colors.ink} strokeLinecap="round" strokeWidth={1.7} /><Circle cx={9} cy={7} fill={colors.surface} r={2} stroke={colors.ink} strokeWidth={1.5} /><Circle cx={15} cy={12} fill={colors.surface} r={2} stroke={colors.ink} strokeWidth={1.5} /><Circle cx={11} cy={17} fill={colors.surface} r={2} stroke={colors.ink} strokeWidth={1.5} /></Svg>;
}

function WavyLine() {
  const { colors } = useAppTheme();
  return <Svg height={26} preserveAspectRatio="none" viewBox="0 0 200 20" width="100%"><Path d="M0 10Q50 0 100 10T200 10" fill="none" stroke={colors.ink} strokeLinecap="round" strokeWidth={4} /></Svg>;
}

function useRoomSetupStyles() {
  const { colors } = useAppTheme();
...
function createStyles(colors: ThemeColors) {
  ...
  statusPage: { alignItems: 'center', backgroundColor: colors.canvas, flex: 1, gap: 12, justifyContent: 'center', padding: 24 },
  statusText: { color: colors.textSecondary, fontSize: 14, textAlign: 'center' },
  appBarShadow: { backgroundColor: colors.ink, paddingBottom: 4 },
  appBar: { alignItems: 'center', backgroundColor: colors.surface, borderBottomColor: colors.ink, borderBottomWidth: 3, flexDirection: 'row', justifyContent: 'space-between', minHeight: 52, paddingBottom: 8, paddingHorizontal: 16 },
  appBarIcon: { alignItems: 'center', height: 32, justifyContent: 'center', width: 32 },
  brand: { color: colors.ink, fontSize: 25, fontWeight: '800', letterSpacing: -1.1, lineHeight: 30, transform: [{ rotate: '-2deg' }] },
  content: { gap: 40, paddingBottom: 138, paddingHorizontal: 16, paddingTop: 40 },
  intro: { gap: 8 },
  title: { color: colors.ink, fontSize: 32, fontWeight: '800', letterSpacing: -1.2, lineHeight: 38 },
  subtitle: { color: colors.textSecondary, fontSize: 17, lineHeight: 27 },
  cards: { gap: 24 },
  cardShadow: { backgroundColor: colors.ink, paddingBottom: 8, paddingRight: 8 },
  card: { backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 3, minHeight: 284, overflow: 'visible', padding: 24, position: 'relative' },
  cardTopline: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24 },
  actionIcon: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.ink, borderRadius: 999, borderWidth: 2, height: 66, justifyContent: 'center', width: 66 },
  actionIconTiltLeft: { transform: [{ rotate: '-6deg' }] },
  actionIconTiltRight: { transform: [{ rotate: '6deg' }] },
  cardCaption: { borderColor: colors.ink, borderWidth: 1, color: colors.ink, fontFamily: 'monospace', fontSize: 10, letterSpacing: 0.25, lineHeight: 13, paddingHorizontal: 8, paddingVertical: 2, transform: [{ rotate: '3deg' }] },
  cardCaptionTilt: { transform: [{ rotate: '-2deg' }] },
  cardTitle: { color: colors.ink, fontSize: 23, fontWeight: '700', letterSpacing: -0.65, lineHeight: 30, marginBottom: 8 },
  cardDescription: { color: colors.ink, fontSize: 15, lineHeight: 22, marginBottom: 24 },
  buttonShadow: { backgroundColor: colors.ink, paddingBottom: 4, paddingRight: 4 },
  button: { alignItems: 'center', borderColor: colors.ink, borderWidth: 3, flexDirection: 'row', gap: 8, justifyContent: 'center', minHeight: 55, paddingHorizontal: 24, paddingVertical: 12 },
  lightButton: { backgroundColor: colors.surface },
  darkButton: { backgroundColor: colors.ink },
  buttonPressed: { transform: [{ translateX: 2 }, { translateY: 2 }] },
  buttonDisabled: { opacity: 0.55 },
  buttonLabel: { color: colors.ink, fontFamily: 'BricolageGrotesque_700Bold', fontSize: 21, fontWeight: '700', letterSpacing: -0.5, lineHeight: 26 },
  darkButtonLabel: { color: colors.surface },
  ...
  codeInput: { borderBottomColor: colors.ink, borderBottomWidth: 3, color: colors.ink, flex: 1, fontFamily: 'BricolageGrotesque_700Bold', fontSize: 22, fontWeight: '700', height: 42, lineHeight: 26, paddingHorizontal: 0, paddingVertical: 0, textAlign: 'center', textAlignVertical: 'center' },
  ...
  recentLabel: { color: colors.ink, fontFamily: 'monospace', fontSize: 11, fontWeight: '500', letterSpacing: 1.5, lineHeight: 14 },
  recentEmpty: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 2, flexDirection: 'row', gap: 16, minHeight: 78, padding: 16 },
  recentEmptyIcon: { alignItems: 'center', borderColor: colors.ink, borderRadius: 999, borderWidth: 2, height: 40, justifyContent: 'center', transform: [{ rotate: '-3deg' }], width: 40 },
  recentEmptyCopy: { flex: 1, gap: 2 },
  recentEmptyTitle: { color: colors.ink, fontSize: 15, fontWeight: '700', lineHeight: 20 },
  recentEmptyDescription: { color: colors.textSecondary, fontSize: 10, lineHeight: 14 },
  roomTopBar: { alignItems: 'center', backgroundColor: colors.canvas, flexDirection: 'row', justifyContent: 'space-between', minHeight: 64, paddingBottom: 8, paddingHorizontal: 16 },
  roomBackButton: { alignItems: 'center', height: 44, justifyContent: 'center', width: 44 },
  roomBackText: { color: colors.ink, fontSize: 42, fontWeight: '300', lineHeight: 42 },
  roomDateGroup: { alignItems: 'center', flexDirection: 'row', gap: 12 },
  roomDateCopy: { maxWidth: 160 },
  roomMark: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.ink, borderRadius: 20, borderWidth: 2, height: 40, justifyContent: 'center', overflow: 'hidden', width: 40 },
  roomMarkText: { color: colors.ink, fontSize: 18, fontWeight: '700' },
  roomDate: { color: colors.ink, fontSize: 19, fontWeight: '700', letterSpacing: -0.35, lineHeight: 24 },
  roomTimeZone: { color: colors.textSecondary, fontFamily: 'monospace', fontSize: 8, letterSpacing: 0.35, lineHeight: 11 },
  ...
  roomBanner: { backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 2.5, maxWidth: '100%', paddingHorizontal: 26, paddingVertical: 13, transform: [{ rotate: '-1deg' }] },
  roomBannerTitle: { color: colors.ink, fontSize: 28, fontWeight: '800', letterSpacing: -0.9, lineHeight: 33, maxWidth: 300, textAlign: 'center' },
  boardSection: { gap: 24 },
  boardState: { alignItems: 'center', backgroundColor: colors.surfaceMuted, borderColor: colors.ink, borderStyle: 'dashed', borderWidth: 1.5, flexDirection: 'row', gap: 10, minHeight: 82, padding: 16 },
  boardStateText: { color: colors.textSecondary, flex: 1, fontSize: 12, lineHeight: 18 },
  boardRetry: { backgroundColor: colors.surfaceMuted, borderColor: colors.ink, borderWidth: 1.5, gap: 4, padding: 16 },
  boardRetryTitle: { color: colors.ink, fontSize: 14, fontWeight: '700' },
  boardRetryText: { color: colors.textSecondary, fontSize: 12 },
  ...
  boardTabAvatar: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.ink, borderRadius: 24, borderWidth: 2, height: 48, justifyContent: 'center', width: 48 },
  boardTabAvatarSelected: { backgroundColor: colors.ink, borderWidth: 3 },
  boardTabInitial: { color: colors.ink, fontSize: 17, fontWeight: '700' },
  boardTabInitialSelected: { color: colors.surface },
  boardTabCopy: { flexShrink: 1, gap: 1 },
  boardTabName: { color: colors.ink, fontSize: 16, fontWeight: '700', lineHeight: 20 },
  boardTabNameSelected: { textDecorationLine: 'underline', textDecorationStyle: 'solid' },
  boardTabStatus: { color: colors.textSecondary, fontFamily: 'monospace', fontSize: 8, letterSpacing: 0.3, lineHeight: 11 },
  boardTabStatusSelected: { color: colors.ink },
  canvasToolbar: { alignItems: 'center', flexDirection: 'row', gap: 12, justifyContent: 'space-between' },
  canvasLabel: { borderBottomColor: colors.ink, borderBottomWidth: 2, color: colors.ink, fontFamily: 'monospace', fontSize: 10, letterSpacing: 0.8, paddingBottom: 4 },
  canvasActions: { flexDirection: 'row', gap: 8 },
  canvasActionButton: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 1.5, flexDirection: 'row', gap: 5, minHeight: 44, paddingHorizontal: 10, paddingVertical: 7 },
  canvasActionButtonDisabled: { opacity: 0.52 },
  canvasActionLabel: { color: colors.ink, fontFamily: 'monospace', fontSize: 10, lineHeight: 13 },
  modalOverlay: { alignItems: 'center', backgroundColor: colors.overlay, flex: 1, justifyContent: 'center', padding: 20 },
  modalCard: { backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 2, boxShadow: `7px 7px 0px ${colors.black}`, gap: 10, maxWidth: 380, padding: 22, width: '100%' },
  modalHeader: { alignItems: 'flex-start', flexDirection: 'row', gap: 12, justifyContent: 'space-between' },
  modalHeaderCopy: { flex: 1 },
  modalEyebrow: { color: colors.textSecondary, fontFamily: 'monospace', fontSize: 10, letterSpacing: 1 },
  modalTitle: { color: colors.ink, fontSize: 25, fontWeight: '800', letterSpacing: -0.7, lineHeight: 32 },
  modalCloseButton: { alignItems: 'center', borderColor: colors.ink, borderWidth: 1.5, height: 38, justifyContent: 'center', width: 38 },
  modalCloseText: { color: colors.ink, fontSize: 28, fontWeight: '300', lineHeight: 31 },
  modalDescription: { color: colors.textSecondary, fontSize: 14, lineHeight: 21, marginBottom: 6 },
  inputLabel: { color: colors.ink, fontFamily: 'monospace', fontSize: 11, marginTop: 5 },
  modalInput: { backgroundColor: colors.surface, borderColor: colors.ink, borderWidth: 1.5, color: colors.ink, fontSize: 16, minHeight: 48, paddingHorizontal: 12 },
  modalActions: { flexDirection: 'row', gap: 10, justifyContent: 'flex-end', marginTop: 12 },
  modalSecondaryButton: { alignItems: 'center', borderColor: colors.ink, borderWidth: 1.5, justifyContent: 'center', minHeight: 46, paddingHorizontal: 15 },
  modalSecondaryText: { color: colors.ink, fontSize: 14, fontWeight: '700' },
  modalPrimaryButton: { alignItems: 'center', backgroundColor: colors.ink, boxShadow: `3px 3px 0px ${colors.black}`, justifyContent: 'center', minHeight: 46, paddingHorizontal: 15 },
  modalPrimaryText: { color: colors.surface, fontSize: 14, fontWeight: '700' },
  modalButtonDisabled: { opacity: 0.54 },
  privacyNotice: { backgroundColor: colors.surfaceMuted, borderColor: colors.warning, borderWidth: 1, gap: 5, marginTop: 4, padding: 12 },
  privacyNoticeTitle: { color: colors.ink, fontSize: 13, fontWeight: '700' },
  privacyNoticeText: { color: colors.ink, fontSize: 12, lineHeight: 18 },
  });
}
